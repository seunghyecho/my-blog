...
import { fetchCreatePost, fetchUpdatePost } from "pages/api/posts";
...
function Form({ data, postId }: prop) {
  ...
  return (
    <>
      <MetaTag title={postId ? post.title : "새 글 작성하기"} />
      ...
      <TagBox onChangeTags={onChangeTags} tags={postId ? post.tags : tags} />
